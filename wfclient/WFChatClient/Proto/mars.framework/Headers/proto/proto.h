...
namespace zlead{
    namespace stn{
        ...
        public:
            virtual void onSuccess(const std::list<zlead::stn::TGroupInfo> &groupInfoList) = 0;
            virtual void onFalure(int errorCode) = 0;
        ...
        public:
            virtual void onSuccess(const std::string &groupId, const std::list<zlead::stn::TGroupMember> &groupMemberList) = 0;
            virtual void onFalure(int errorCode) = 0;
        ...
        public:
            virtual void onSuccess(const std::list<zlead::stn::TChannelInfo> &channelInfoList) = 0;
            virtual void onFalure(int errorCode) = 0;
