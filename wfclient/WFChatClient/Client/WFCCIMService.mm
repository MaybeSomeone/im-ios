...
class IMSendMessageCallback : public zlead::stn::SendMsgCallback {
private:
...
public:
    IMSendMessageCallback(WFCCMessage *message, void(^successBlock)(long long messageUid, long long timestamp), void(^progressBlock)(long uploaded, long total), void(^errorBlock)(int error_code)) : zlead::stn::SendMsgCallback(), m_message(message), m_successBlock(successBlock), m_progressBlock(progressBlock), m_errorBlock(errorBlock) {};
...
extern WFCCUserInfo* convertUserInfo(const zlead::stn::TUserInfo &tui);


class IMCreateGroupCallback : public zlead::stn::CreateGroupCallback {
private:
    void(^m_successBlock)(NSString *groupId);
    void(^m_errorBlock)(int error_code);
public:
    IMCreateGroupCallback(void(^successBlock)(NSString *groupId), void(^errorBlock)(int error_code)) : zlead::stn::CreateGroupCallback(), m_successBlock(successBlock), m_errorBlock(errorBlock) {};
...
class IMGeneralOperationCallback : public zlead::stn::GeneralOperationCallback {
private:
    void(^m_successBlock)();
    void(^m_errorBlock)(int error_code);
public:
    IMGeneralOperationCallback(void(^successBlock)(), void(^errorBlock)(int error_code)) : zlead::stn::GeneralOperationCallback(), m_successBlock(successBlock), m_errorBlock(errorBlock) {};
    void onSuccess() {
        dispatch_async(dispatch_get_main_queue(), ^{
            if (m_successBlock) {
                m_successBlock();
...
class RecallMessageCallback : public zlead::stn::GeneralOperationCallback {
private:
    void(^m_successBlock)();
    void(^m_errorBlock)(int error_code);
    WFCCMessage *message;
public:
    RecallMessageCallback(WFCCMessage *msg, void(^successBlock)(), void(^errorBlock)(int error_code)) : zlead::stn::GeneralOperationCallback(), m_successBlock(successBlock), m_errorBlock(errorBlock), message(msg) {};
    void onSuccess() {
...
class IMGetChatroomInfoCallback : public zlead::stn::GetChatroomInfoCallback {
private:
    NSString *chatroomId;
    void(^m_successBlock)(WFCCChatroomInfo *chatroomInfo);
    void(^m_errorBlock)(int error_code);
public:
    IMGetChatroomInfoCallback(NSString *cid, void(^successBlock)(WFCCChatroomInfo *chatroomInfo), void(^errorBlock)(int error_code)) : zlead::stn::GetChatroomInfoCallback(), chatroomId(cid),  m_successBlock(successBlock), m_errorBlock(errorBlock) {};
    void onSuccess(const zlead::stn::TChatroomInfo &info) {
...
extern NSMutableArray* convertProtoMessageList(const std::list<zlead::stn::TMessage> &messageList, BOOL reverse);

class IMLoadRemoteMessagesCallback : public zlead::stn::LoadRemoteMessagesCallback {
private:
    void(^m_successBlock)(NSArray<WFCCMessage *> *messages);
    void(^m_errorBlock)(int error_code);
public:
    IMLoadRemoteMessagesCallback(void(^successBlock)(NSArray<WFCCMessage *> *messages), void(^errorBlock)(int error_code)) : zlead::stn::LoadRemoteMessagesCallback(), m_successBlock(successBlock), m_errorBlock(errorBlock) {};
    void onSuccess(const std::list<zlead::stn::TMessage> &messageList) {
...
class IMGetChatroomMemberInfoCallback : public zlead::stn::GetChatroomMemberInfoCallback {
private:
    void(^m_successBlock)(WFCCChatroomMemberInfo *chatroomMemberInfo);
    void(^m_errorBlock)(int error_code);
public:
    IMGetChatroomMemberInfoCallback(void(^successBlock)(WFCCChatroomMemberInfo *chatroomMemberInfo), void(^errorBlock)(int error_code)) : zlead::stn::GetChatroomMemberInfoCallback(), m_successBlock(successBlock), m_errorBlock(errorBlock) {};
    void onSuccess(const zlead::stn::TChatroomMemberInfo &info) {
...
class IMGetGroupInfoCallback : public zlead::stn::GetGroupInfoCallback {
private:
    void(^m_successBlock)(NSArray<WFCCGroupInfo *> *);
    void(^m_errorBlock)(int error_code);
public:
    IMGetGroupInfoCallback(void(^successBlock)(NSArray<WFCCGroupInfo *> *), void(^errorBlock)(int error_code)) : zlead::stn::GetGroupInfoCallback(), m_successBlock(successBlock), m_errorBlock(errorBlock) {};
    void onSuccess(const std::list<const zlead::stn::TGroupInfo> &groupInfoList) {
        
        NSMutableArray *ret = nil;
        if (m_successBlock) {
            NSMutableArray *ret = [[NSMutableArray alloc] init];
            for (std::list<const zlead::stn::TGroupInfo>::const_iterator it = groupInfoList.begin(); it != groupInfoList.end(); it++) {
                WFCCGroupInfo *gi = [[WFCCGroupInfo alloc] init];
                const zlead::stn::TGroupInfo &tgi = *it;
...
class GeneralUpdateMediaCallback : public zlead::stn::UpdateMediaCallback {
public:
  void(^m_successBlock)(NSString *remoteUrl);
  void(^m_errorBlock)(int error_code);
  void(^m_progressBlock)(long uploaded, long total);
  
  GeneralUpdateMediaCallback(void(^successBlock)(NSString *remoteUrl), void(^progressBlock)(long uploaded, long total), void(^errorBlock)(int error_code)) : zlead::stn::UpdateMediaCallback(), m_successBlock(successBlock), m_progressBlock(progressBlock), m_errorBlock(errorBlock) {}
...
static WFCCMessage *convertProtoMessage(const zlead::stn::TMessage *tMessage) {
...
NSMutableArray* convertProtoMessageList(const std::list<zlead::stn::TMessage> &messageList, BOOL reverse) {
    NSMutableArray *messages = [[NSMutableArray alloc] init];
    for (std::list<zlead::stn::TMessage>::const_iterator it = messageList.begin(); it != messageList.end(); it++) {
        const zlead::stn::TMessage &tmsg = *it;
...
static WFCCConversationInfo* convertConversationInfo(const zlead::stn::TConversation &tConv) {
...
static void fillTMessageContent(zlead::stn::TMessageContent &tmsgcontent, WFCCMessageContent *content) {
...
static void fillTMessage(zlead::stn::TMessage &tmsg, WFCCConversation *conv, WFCCMessageContent *content) {
    tmsg.conversationType = conv.type;
    tmsg.target = conv.target ? [conv.target UTF8String] : "";
    tmsg.line = conv.line;
    tmsg.from = zlead::app::GetAccountUserName();
    tmsg.status = zlead::stn::MessageStatus::Message_Status_Sending;
...
- (WFCCMessage *)sendMedia:(WFCCConversation *)conversation
    ...
    zlead::stn::sendMessage(tmsg, new IMSendMessageCallback(message, successBlock, progressBlock, errorBlock), expireDuration);
...
- (void)recall:(WFCCMessage *)msg
    ...
    zlead::stn::recallMessage(msg.messageUid, new RecallMessageCallback(msg, successBlock, errorBlock));
}
- (NSArray<WFCCConversationInfo *> *)getConversationInfos:(NSArray<NSNumber *> *)conversationTypes lines:(NSArray<NSNumber *> *)lines{
    ...
    std::list<zlead::stn::TConversation> convers = zlead::stn::MessageDB::Instance()->GetConversationList(types, ls);
    NSMutableArray *ret = [[NSMutableArray alloc] init];
    for (std::list<zlead::stn::TConversation>::iterator it = convers.begin(); it != convers.end(); it++) {
        zlead::stn::TConversation &tConv = *it;
...
- (WFCCConversationInfo *)getConversationInfo:(WFCCConversation *)conversation {
    zlead::stn::TConversation tConv = zlead::stn::MessageDB::Instance()->GetConversation(conversation.type, [conversation.target UTF8String], conversation.line);
...
- (NSArray<WFCCMessage *> *)getMessages:(WFCCConversation *)conversation contentTypes:(NSArray<NSNumber *> *)contentTypes from:(NSUInteger)fromIndex count:(NSInteger)count withUser:(NSString *)user {
    ...
    std::list<zlead::stn::TMessage> messages = zlead::stn::MessageDB::Instance()->GetMessages(conversation.type, [conversation.target UTF8String], conversation.line, types, direction, (int)count, fromIndex, user ? [user UTF8String] : "");
...
- (void)getRemoteMessages:(WFCCConversation *)conversation
                  ...
                  success:(void(^)(NSArray<WFCCMessage *> *messages))successBlock
                    error:(void(^)(int error_code))errorBlock {
    zlead::stn::TConversation conv;
    conv.target = [conversation.target UTF8String];
    conv.line = conversation.line;
    conv.conversationType = conversation.type;
    zlead::stn::loadRemoteMessages(conv, beforeMessageUid, (int)count, new IMLoadRemoteMessagesCallback(successBlock, errorBlock));
}

- (WFCCMessage *)getMessage:(long)messageId {
  zlead::stn::TMessage tMsg = zlead::stn::MessageDB::Instance()->GetMessageById(messageId);
  return convertProtoMessage(&tMsg);
}

- (WFCCMessage *)getMessageByUid:(long long)messageUid {
  zlead::stn::TMessage tMsg = zlead::stn::MessageDB::Instance()->GetMessageByUid(messageUid);
  return convertProtoMessage(&tMsg);
}

- (WFCCUnreadCount *)getUnreadCount:(WFCCConversation *)conversation {
    zlead::stn::TUnreadCount tcount = zlead::stn::MessageDB::Instance()->GetUnreadCount(conversation.type, [conversation.target UTF8String], conversation.line);
...
- (WFCCUnreadCount *)getUnreadCount:(NSArray<NSNumber *> *)conversationTypes lines:(NSArray<NSNumber *> *)lines {
    ...
    zlead::stn::TUnreadCount tcount =  zlead::stn::MessageDB::Instance()->GetUnreadCount(types, ls);
    return [WFCCUnreadCount countOf:tcount.unread mention:tcount.unreadMention mentionAll:tcount.unreadMentionAll];
}

- (void)clearUnreadStatus:(WFCCConversation *)conversation {
    zlead::stn::MessageDB::Instance()->ClearUnreadStatus(conversation.type, [conversation.target UTF8String], conversation.line);
}

- (void)clearAllUnreadStatus {
    zlead::stn::MessageDB::Instance()->ClearAllUnreadStatus();
}
...
- (void)setMediaMessagePlayed:(long)messageId {
    ...
    zlead::stn::MessageDB::Instance()->updateMessageStatus(messageId, zlead::stn::Message_Status_Played);
}

- (void)removeConversation:(WFCCConversation *)conversation clearMessage:(BOOL)clearMessage {
    zlead::stn::MessageDB::Instance()->RemoveConversation(conversation.type, [conversation.target UTF8String], conversation.line, clearMessage);
}

- (void)clearMessages:(WFCCConversation *)conversation {
    zlead::stn::MessageDB::Instance()->ClearMessages(conversation.type, [conversation.target UTF8String], conversation.line);
}

- (void)setConversation:(WFCCConversation *)conversation top:(BOOL)top
                success:(void(^)(void))successBlock
                  error:(void(^)(int error_code))errorBlock {
//    zlead::stn::MessageDB::Instance()->updateConversationIsTop(conversation.type, [conversation.target UTF8String], conversation.line, top);
    
    [self setUserSetting:(UserSettingScope)zlead::stn::kUserSettingConversationTop key:[NSString stringWithFormat:@"%zd-%d-%@", conversation.type, conversation.line, conversation.target] value:top ? @"1" : @"0" success:successBlock error:errorBlock];
}

- (void)setConversation:(WFCCConversation *)conversation draft:(NSString *)draft {
    zlead::stn::MessageDB::Instance()->updateConversationDraft(conversation.type, [conversation.target UTF8String], conversation.line, draft ? [draft UTF8String] : "");
}

class IMSearchUserCallback : public zlead::stn::SearchUserCallback {
private:
...
public:
    ...
    void onSuccess(const std::list<zlead::stn::TUserInfo> &users, const std::string &keyword, int page) {
        NSMutableArray *outUsers = [[NSMutableArray alloc] initWithCapacity:users.size()];
        for(std::list<zlead::stn::TUserInfo>::const_iterator it = users.begin(); it != users.end(); it++) {
...
- (void)searchUser:(NSString *)keyword success:(void(^)(NSArray<WFCCUserInfo *> *machedUsers))successBlock error:(void(^)(int errorCode))errorBlock {
    ...
    zlead::stn::searchUser([keyword UTF8String], YES, 0, new IMSearchUserCallback(successBlock, errorBlock));
}

- (BOOL)isMyFriend:(NSString *)userId {
    return zlead::stn::MessageDB::Instance()->isMyFriend([userId UTF8String]);
}

- (NSArray<NSString *> *)getMyFriendList:(BOOL)refresh {
    NSMutableArray *ret = [[NSMutableArray alloc] init];
    std::list<std::string> friendList = zlead::stn::MessageDB::Instance()->getMyFriendList(refresh);
...
- (NSArray<WFCCUserInfo *> *)searchFriends:(NSString *)keyword {
    std::list<zlead::stn::TUserInfo> friends = zlead::stn::MessageDB::Instance()->SearchFriends([keyword UTF8String], 50);
    NSMutableArray<WFCCUserInfo *> *ret = [[NSMutableArray alloc] init];
    for (std::list<zlead::stn::TUserInfo>::iterator it = friends.begin(); it != friends.end(); it++) {
...
WFCCChannelInfo *convertProtoChannelInfo(const zlead::stn::TChannelInfo &tci) {
...
class IMCreateChannelCallback : public zlead::stn::CreateChannelCallback {
private:
    void(^m_successBlock)(WFCCChannelInfo *channelInfo);
    void(^m_errorBlock)(int error_code);
public:
    IMCreateChannelCallback(void(^successBlock)(WFCCChannelInfo *channelInfo), void(^errorBlock)(int error_code)) : zlead::stn::CreateChannelCallback(), m_successBlock(successBlock), m_errorBlock(errorBlock) {};
    void onSuccess(const zlead::stn::TChannelInfo &channelInfo) {
...
class IMSearchChannelCallback : public zlead::stn::SearchChannelCallback {
private:
...
public:
    ...
    void onSuccess(const std::list<zlead::stn::TChannelInfo> &users, const std::string &keyword) {
        NSMutableArray *outUsers = [[NSMutableArray alloc] initWithCapacity:users.size()];
        for(std::list<zlead::stn::TChannelInfo>::const_iterator it = users.begin(); it != users.end(); it++) {
...
WFCCGroupInfo *convertProtoGroupInfo(zlead::stn::TGroupInfo tgi) {
    if (tgi.target.empty()) {
        return nil;
    }
...
- (NSArray<WFCCGroupSearchInfo *> *)searchGroups:(NSString *)keyword {
    std::list<zlead::stn::TGroupSearchResult> groups = zlead::stn::MessageDB::Instance()->SearchGroups([keyword UTF8String], 50);
    NSMutableArray<WFCCGroupSearchInfo *> *ret = [[NSMutableArray alloc] init];
    for (std::list<zlead::stn::TGroupSearchResult>::iterator it = groups.begin(); it != groups.end(); it++) {
...
- (NSArray<WFCCFriendRequest *> *)convertFriendRequest:(std::list<zlead::stn::TFriendRequest>)tRequests {
    NSMutableArray *ret = [[NSMutableArray alloc] init];
    for (std::list<zlead::stn::TFriendRequest>::iterator it = tRequests.begin(); it != tRequests.end(); it++) {
        WFCCFriendRequest *request = [[WFCCFriendRequest alloc] init];
        zlead::stn::TFriendRequest *tRequest = &(*it);
...
- (void)loadFriendRequestFromRemote {
    zlead::stn::loadFriendRequestFromRemote();
}

- (NSArray<WFCCFriendRequest *> *)getIncommingFriendRequest {
    std::list<zlead::stn::TFriendRequest> tRequests = zlead::stn::MessageDB::Instance()->getFriendRequest(1);
    return [self convertFriendRequest:tRequests];
}

- (NSArray<WFCCFriendRequest *> *)getOutgoingFriendRequest {
    std::list<zlead::stn::TFriendRequest> tRequests = zlead::stn::MessageDB::Instance()->getFriendRequest(0);
    return [self convertFriendRequest:tRequests];
}

- (void)clearUnreadFriendRequestStatus {
    zlead::stn::MessageDB::Instance()->clearUnreadFriendRequestStatus();
}

- (int)getUnreadFriendRequestStatus {
    return zlead::stn::MessageDB::Instance()->unreadFriendRequest();
}
...
- (void)sendFriendRequest:(NSString *)userId
                  ...
                  success:(void(^)())successBlock
                    error:(void(^)(int error_code))errorBlock {
    zlead::stn::sendFriendRequest([userId UTF8String], [reason UTF8String], new IMGeneralOperationCallback(successBlock, errorBlock));
}
...
- (void)handleFriendRequest:(NSString *)userId
                    ...
                    success:(void(^)())successBlock
                      error:(void(^)(int error_code))errorBlock {
    zlead::stn::handleFriendRequest([userId UTF8String], accpet, new IMGeneralOperationCallback(successBlock, errorBlock));
}

- (void)deleteFriend:(NSString *)userId
             success:(void(^)())successBlock
               error:(void(^)(int error_code))errorBlock {
    zlead::stn::deleteFriend([userId UTF8String], new IMGeneralOperationCallback(successBlock, errorBlock));
}

- (NSString *)getFriendAlias:(NSString *)friendId {
    std::string strAlias = zlead::stn::MessageDB::Instance()->GetFriendAlias([friendId UTF8String]);
...
- (void)setFriend:(NSString *)friendId
          ...
          success:(void(^)(void))successBlock
            error:(void(^)(int error_code))errorBlock {
    zlead::stn::setFriendAlias([friendId UTF8String], alias ? [alias UTF8String] : "", new IMGeneralOperationCallback(successBlock, errorBlock));
}

- (BOOL)isBlackListed:(NSString *)userId {
    return zlead::stn::MessageDB::Instance()->isBlackListed([userId UTF8String]);
}

- (NSArray<NSString *> *)getBlackList:(BOOL)refresh {
    NSMutableArray *ret = [[NSMutableArray alloc] init];
    std::list<std::string> friendList = zlead::stn::MessageDB::Instance()->getBlackList(refresh);
    for (std::list<std::string>::iterator it = friendList.begin(); it != friendList.end(); it++) {
        [ret addObject:[NSString stringWithUTF8String:(*it).c_str()]];
    }
    return ret;
...
- (void)setBlackList:(NSString *)userId
       isBlackListed:(BOOL)isBlackListed
             success:(void(^)(void))successBlock
               error:(void(^)(int error_code))errorBlock {
    zlead::stn::blackListRequest([userId UTF8String], isBlackListed, new IMGeneralOperationCallback(successBlock, errorBlock));
}
...
- (WFCCUserInfo *)getUserInfo:(NSString *)userId inGroup:(NSString *)groupId refresh:(BOOL)refresh {
    ...
    zlead::stn::TUserInfo tui = zlead::stn::MessageDB::Instance()->getUserInfo([userId UTF8String], groupId ? [groupId UTF8String] : "", refresh);
    if (!tui.uid.empty()) {
...
- (NSArray<WFCCUserInfo *> *)getUserInfos:(NSArray<NSString *> *)userIds inGroup:(NSString *)groupId {
    ...
    std::list<zlead::stn::TUserInfo> tuis = zlead::stn::MessageDB::Instance()->getUserInfos(strIds, groupId ? [groupId UTF8String] : "");
    
    NSMutableArray<WFCCUserInfo *> *ret = [[NSMutableArray alloc] init];
    for (std::list<zlead::stn::TUserInfo>::iterator it = tuis.begin(); it != tuis.end(); it++) {
        WFCCUserInfo *userInfo = convertUserInfo(*it);
        [ret addObject:userInfo];
    }
    return ret;
...
- (void)uploadMedia:(NSData *)mediaData
          mediaType:(WFCCMediaType)mediaType
           ...
           progress:(void(^)(long uploaded, long total))progressBlock
              error:(void(^)(int error_code))errorBlock {
    zlead::stn::uploadGeneralMedia(std::string((char *)mediaData.bytes, mediaData.length), mediaType, new GeneralUpdateMediaCallback(successBlock, progressBlock, errorBlock));
}
...
-(void)modifyMyInfo:(NSDictionary<NSNumber */*ModifyMyInfoType*/, NSString *> *)values
    ...
    zlead::stn::modifyMyInfo(infos, new IMGeneralOperationCallback(successBlock, errorBlock));
}
...
- (BOOL)deleteMessage:(long)messageId {
    return zlead::stn::MessageDB::Instance()->DeleteMessage(messageId);
}
...
- (NSArray<WFCCConversationSearchInfo *> *)searchConversation:(NSString *)keyword inConversation:(NSArray<NSNumber *> *)conversationTypes lines:(NSArray<NSNumber *> *)lines {
    ...
    std::list<zlead::stn::TConversationSearchresult> tresult = zlead::stn::MessageDB::Instance()->SearchConversations(types, ls, [keyword UTF8String], 50);
    NSMutableArray *results = [[NSMutableArray alloc] init];
    for (std::list<zlead::stn::TConversationSearchresult>::iterator it = tresult.begin(); it != tresult.end(); it++) {
...
- (NSArray<WFCCMessage *> *)searchMessage:(WFCCConversation *)conversation keyword:(NSString *)keyword {
    ...
    std::list<zlead::stn::TMessage> tmessages = zlead::stn::MessageDB::Instance()->SearchMessages(conversation.type, [conversation.target UTF8String], conversation.line, [keyword UTF8String], 500);
...
- (void)createGroup:(NSString *)groupId
    ...
    zlead::stn::TMessageContent tcontent;
    ...
    zlead::stn::createGroup(groupId == nil ? "" : [groupId UTF8String], groupName == nil ? "" : [groupName UTF8String], groupPortrait == nil ? "" : [groupPortrait UTF8String], memberList, lines, tcontent, new IMCreateGroupCallback(successBlock, errorBlock));
}
...
- (void)addMembers:(NSArray *)members
    ...
    zlead::stn::addMembers([groupId UTF8String], memberList, lines, tcontent, new IMGeneralOperationCallback(successBlock, errorBlock));
}
...
- (void)kickoffMembers:(NSArray *)members
    ...
    zlead::stn::kickoffMembers([groupId UTF8String], memberList, lines, tcontent, new IMGeneralOperationCallback(successBlock, errorBlock));
}
...
- (void)quitGroup:(NSString *)groupId
    ...
    zlead::stn::quitGroup([groupId UTF8String], lines, tcontent, new IMGeneralOperationCallback(successBlock, errorBlock));
}
...
- (void)dismissGroup:(NSString *)groupId
    ...
    zlead::stn::dismissGroup([groupId UTF8String], lines, tcontent, new IMGeneralOperationCallback(successBlock, errorBlock));
}
...
- (void)modifyGroupInfo:(NSString *)groupId
    ...
    zlead::stn::modifyGroupInfo([groupId UTF8String], (int)type, [newValue UTF8String], lines, tcontent, new IMGeneralOperationCallback(successBlock, errorBlock));
}
...
- (void)modifyGroupAlias:(NSString *)groupId
    ...
    zlead::stn::modifyGroupAlias([groupId UTF8String], [newAlias UTF8String], lines, tcontent, new IMGeneralOperationCallback(successBlock, errorBlock));
}

- (NSArray<WFCCGroupMember *> *)getGroupMembers:(NSString *)groupId
                             forceUpdate:(BOOL)forceUpdate {
    std::list<zlead::stn::TGroupMember> tmembers = zlead::stn::MessageDB::Instance()->GetGroupMembers([groupId UTF8String], forceUpdate);
    NSMutableArray *output = [[NSMutableArray alloc] init];
    for(std::list<zlead::stn::TGroupMember>::iterator it = tmembers.begin(); it != tmembers.end(); it++) {
...
- (WFCCGroupMember *)getGroupMember:(NSString *)groupId
    ...
    zlead::stn::TGroupMember tmember = zlead::stn::MessageDB::Instance()->GetGroupMember([groupId UTF8String], [memberId UTF8String]);
...
- (void)transferGroup:(NSString *)groupId
    ...
    zlead::stn::transferGroup([groupId UTF8String], [newOwner UTF8String], lines, tcontent, new IMGeneralOperationCallback(successBlock, errorBlock));
}
...
- (WFCCGroupInfo *)getGroupInfo:(NSString *)groupId refresh:(BOOL)refresh {
    zlead::stn::TGroupInfo tgi = zlead::stn::MessageDB::Instance()->GetGroupInfo([groupId UTF8String], refresh);
...
- (NSString *)getUserSetting:(UserSettingScope)scope key:(NSString *)key {
    ...
    std::string str = zlead::stn::MessageDB::Instance()->GetUserSetting(scope, [key UTF8String]);
    return [NSString stringWithUTF8String:str.c_str()];
}

- (NSDictionary<NSString *, NSString *> *)getUserSettings:(UserSettingScope)scope {
    std::map<std::string, std::string> settings = zlead::stn::MessageDB::Instance()->GetUserSettings(scope);
...
- (void)setUserSetting:(UserSettingScope)scope key:(NSString *)key value:(NSString *)value
               success:(void(^)())successBlock
                 error:(void(^)(int error_code))errorBlock {
    zlead::stn::modifyUserSetting(scope, [key UTF8String], [value UTF8String], new IMGeneralOperationCallback(successBlock, errorBlock));
}

- (void)setConversation:(WFCCConversation *)conversation silent:(BOOL)silent
                success:(void(^)())successBlock
                  error:(void(^)(int error_code))errorBlock {
    [self setUserSetting:(UserSettingScope)zlead::stn::kUserSettingConversationSilent key:[NSString stringWithFormat:@"%zd-%d-%@", conversation.type, conversation.line, conversation.target] value:silent ? @"1" : @"0" success:successBlock error:errorBlock];
}
...
- (WFCCMessage *)insert:(WFCCConversation *)conversation
    ...
    tmsg.status = (zlead::stn::MessageStatus)status;
    
    if(serverTime > 0) {
        tmsg.timestamp = serverTime;
    }
    
    long msgId = zlead::stn::MessageDB::Instance()->InsertMessage(tmsg);
    message.messageId = msgId;
    if(msgId > 0) {
        zlead::stn::MessageDB::Instance()->updateConversationTimestamp(tmsg.conversationType, tmsg.target, tmsg.line, tmsg.timestamp);
    }
...
- (void)updateMessage:(long)messageId
              content:(WFCCMessageContent *)content {
    zlead::stn::TMessageContent tmc;
    fillTMessageContent(tmc, content);
    zlead::stn::MessageDB::Instance()->UpdateMessageContent(messageId, tmc);
}
...
- (void)registerMessageContent:(Class)contentClass {
    ...
    if (class_getClassMethod(contentClass, @selector(getContentType))) {
        ...
        zlead::stn::MessageDB::Instance()->RegisterMessageFlag(contenttype, contentflag);
    } else {
        return;
    }
}
...
- (void)joinChatroom:(NSString *)chatroomId
             success:(void(^)(void))successBlock
               error:(void(^)(int error_code))errorBlock {
    zlead::stn::joinChatroom([chatroomId UTF8String], new IMGeneralOperationCallback(successBlock, errorBlock));
}

- (void)quitChatroom:(NSString *)chatroomId
             success:(void(^)(void))successBlock
               error:(void(^)(int error_code))errorBlock {
    zlead::stn::quitChatroom([chatroomId UTF8String], new IMGeneralOperationCallback(successBlock, errorBlock));
}
...
- (void)getChatroomInfo:(NSString *)chatroomId
                ...
                success:(void(^)(WFCCChatroomInfo *chatroomInfo))successBlock
                  error:(void(^)(int error_code))errorBlock {
    zlead::stn::getChatroomInfo([chatroomId UTF8String], updateDt, new IMGetChatroomInfoCallback(chatroomId, successBlock, errorBlock));
}
...
- (void)getChatroomMemberInfo:(NSString *)chatroomId
    ...
    zlead::stn::getChatroomMemberInfo([chatroomId UTF8String], maxCount, new IMGetChatroomMemberInfoCallback(successBlock, errorBlock));
}
...
- (void)createChannel:(NSString *)channelName
    ...
    zlead::stn::createChannel("", [channelName UTF8String], [channelPortrait UTF8String], status, [desc UTF8String], [extra UTF8String], "", "", new IMCreateChannelCallback(successBlock, errorBlock));
}

- (void)destoryChannel:(NSString *)channelId
              success:(void(^)(void))successBlock
                error:(void(^)(int error_code))errorBlock {
    zlead::stn::destoryChannel([channelId UTF8String], new IMGeneralOperationCallback(successBlock, errorBlock));
}

- (WFCCChannelInfo *)getChannelInfo:(NSString *)channelId
                            refresh:(BOOL)refresh {
    zlead::stn::TChannelInfo tgi = zlead::stn::MessageDB::Instance()->GetChannelInfo([channelId UTF8String], refresh);
...
- (void)modifyChannelInfo:(NSString *)channelId
                 ...
                 newValue:(NSString *)newValue
                  success:(void(^)(void))successBlock
                    error:(void(^)(int error_code))errorBlock {
    zlead::stn::modifyChannelInfo([channelId UTF8String], type, [newValue UTF8String], new IMGeneralOperationCallback(successBlock, errorBlock));
}
...
- (void)searchChannel:(NSString *)keyword success:(void(^)(NSArray<WFCCChannelInfo *> *machedChannels))successBlock error:(void(^)(int errorCode))errorBlock {
    ...
    zlead::stn::searchChannel([keyword UTF8String], YES, new IMSearchChannelCallback(successBlock, errorBlock));
}
...
- (void)listenChannel:(NSString *)channelId listen:(BOOL)listen success:(void(^)(void))successBlock error:(void(^)(int errorCode))errorBlock {
    zlead::stn::listenChannel([channelId UTF8String], listen, new IMGeneralOperationCallback(successBlock, errorBlock));
}
