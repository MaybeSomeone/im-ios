...
- (void)viewDidLoad {
    ...
    NSMutableAttributedString *text = [[NSMutableAttributedString alloc] initWithString:@"登陆即代表你已同意《汉利别墅IM用户协议》和《汉利别墅IM隐私政策》" attributes:@{NSFontAttributeName : [UIFont systemFontOfSize:10],
...
- (BOOL)isValidNumber {
    ...
    // && ([regextestmobile evaluateWithObject:self.userNameField.text] == YES
